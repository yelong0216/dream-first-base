...
public final class DreamFirstGsonSupplier {
	...
	public synchronized static void setDefaultGson(Gson defaultGson) {
		DreamFirstGsonSupplier.defaultGson = defaultGson;
	}
	...
	public static void setDefaultGsonBuilder(GsonBuilder defaultGsonBuilder) {
		DreamFirstGsonSupplier.defaultGsonBuilder = defaultGsonBuilder;
	}
